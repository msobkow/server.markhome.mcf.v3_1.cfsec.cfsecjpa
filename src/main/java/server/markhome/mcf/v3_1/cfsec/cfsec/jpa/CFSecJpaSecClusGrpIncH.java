// Description: Java 25 JPA implementation of SecClusGrpInc history objects
...
/**
 *  CFSecJpaSecClusGrpIncH provides history objects matching the CFSecSecClusGrpInc change history.
 */
@Entity
@Table(
    name = "SecClusGrpInc_h", schema = "CFSec31",
    indexes = {
        @Index(name = "SecClusGrpIncIdIdx_h", columnList = "auditClusterId, auditStamp, auditAction, requiredRevision, auditSessionId, SecClusGrpId, inc_name", unique = true),
        @Index(name = "SecClusGrpIncClusGrpIdx_h", columnList = "SecClusGrpId", unique = false),
        @Index(name = "SecClusGrpIncNameIdx_h", columnList = "inc_name", unique = false)
    }
)
@Transactional(Transactional.TxType.SUPPORTS)
@PersistenceContext(unitName = "CFSecPU")
public class CFSecJpaSecClusGrpIncH
    implements ICFSecSecClusGrpIncH, Comparable<Object>, Serializable
{
    ...
    @EmbeddedId
    protected CFSecJpaSecClusGrpIncHPKey pkey;
	@AttributeOverrides({
    ...
    public CFSecJpaSecClusGrpIncH() {
            // The primary key member attributes are initialized on construction
            pkey = new CFSecJpaSecClusGrpIncHPKey();
    }
    ...
    public void setPKey( ICFSecSecClusGrpIncHPKey pkey ) {
        if (pkey != null) {
            if (pkey instanceof CFSecJpaSecClusGrpIncHPKey) {
                this.pkey = (CFSecJpaSecClusGrpIncHPKey)pkey;
            }
            else {
                throw new CFLibUnsupportedClassException(getClass(), "setPKey", "pkey", pkey, "CFSecJpaSecClusGrpIncHPKey");
            }
        }
    }
    ...
    public String toString() {
        String ret = "<CFSecJpaSecClusGrpIncH" + getXmlAttrFragment() + "/>";
        return( ret );
    }
}
