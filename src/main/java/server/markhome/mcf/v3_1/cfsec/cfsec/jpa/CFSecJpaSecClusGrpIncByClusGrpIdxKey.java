// Description: Java 25 JPA implementation of a SecClusGrpInc by ClusGrpIdx index key object.
...
public class CFSecJpaSecClusGrpIncByClusGrpIdxKey
	implements ICFSecSecClusGrpIncByClusGrpIdxKey, Comparable<Object>, Serializable
{
	...
	public CFSecJpaSecClusGrpIncByClusGrpIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecClusGrpIncByClusGrpIdxKey, ICFSecSecClusGrpInc, ICFSecSecClusGrpIncH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecClusGrpIncByClusGrpIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
