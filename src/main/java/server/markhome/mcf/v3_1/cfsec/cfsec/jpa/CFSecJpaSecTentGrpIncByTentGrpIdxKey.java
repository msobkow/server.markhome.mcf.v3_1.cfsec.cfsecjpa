// Description: Java 25 JPA implementation of a SecTentGrpInc by TentGrpIdx index key object.
...
public class CFSecJpaSecTentGrpIncByTentGrpIdxKey
	implements ICFSecSecTentGrpIncByTentGrpIdxKey, Comparable<Object>, Serializable
{
	...
	public CFSecJpaSecTentGrpIncByTentGrpIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecTentGrpIncByTentGrpIdxKey, ICFSecSecTentGrpInc, ICFSecSecTentGrpIncH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecTentGrpIncByTentGrpIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
