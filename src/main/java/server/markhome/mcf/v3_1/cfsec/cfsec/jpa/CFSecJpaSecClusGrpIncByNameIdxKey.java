// Description: Java 25 JPA implementation of a SecClusGrpInc by NameIdx index key object.
	...
	implements ICFSecSecClusGrpIncByNameIdxKey, Comparable<Object>, Serializable
{
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecClusGrpIncByNameIdxKey, ICFSecSecClusGrpInc, ICFSecSecClusGrpIncH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecClusGrpIncByNameIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
