// Description: Java 25 JPA implementation of a SecSysGrp by SecLevelNmIdx index key object.
...
public class CFSecJpaSecSysGrpBySecLevelNmIdxKey
	implements ICFSecSecSysGrpBySecLevelNmIdxKey, Comparable<Object>, Serializable
{
	...
	public CFSecJpaSecSysGrpBySecLevelNmIdxKey() {
	...
	public int compareTo( Object obj ) {
		...
		if (obj == null) {
			...
			throw new CFLibUnsupportedClassException(getClass(),
				...
				"obj",
				obj,
				"ICFSecSecSysGrpBySecLevelNmIdxKey, ICFSecSecSysGrp, ICFSecSecSysGrpH");
		}
	}
	...
	public String toString() {
		String ret = "<CFSecSecSysGrpBySecLevelNmIdxKey" + getXmlAttrFragment() + "/>";
		return( ret );
	}
}
